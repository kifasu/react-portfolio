    ...
    return (
        ...
        <div className="about-contact">
            ...
            <div className="about">
                ...
                <p className="abt-p">I'm a graduate of the local university in Malaysia. Being a science major, I know how to do most biotech-related stuff like gene extraction, statistical data analysis, and some plant pathology lab work . Though I understand these kinds of things at a surface-level and by no necessary means an expert yet, I'm pretty confident in my skills to learn and get the job done. 
<br/><br/>
Recently, I found a book that changed the way I have been learning things. TLDR; that book has fair points on why I don't need to limit myself to one thing. What you know today do not necessarily determine what you want pursue in the future. Sounds dramatic but it's true. Since then, I get excited about learning new technologies and do what I enjoy the best.
</p>
            </div>
